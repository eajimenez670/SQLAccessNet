...
namespace OpheliaSuiteV2.Core.DataAccess.SQL
{
	...
	{
		// <summary>
		// A string like "El repositorio {0} no ha sido inicializado"
		// </summary>
		internal static string RepositoryNotInitialized(object p0)
		{
			return EntityRes.GetString(EntityRes.RepositoryNotInitialized, p0);
		}
	}
	...
	{
        internal const string RepositoryNotInitialized = "RepositoryNotInitialized";
		...
		private EntityRes()
		{
			resources = new ResourceManager(
				"OpheliaSuiteV2.Core.DataAccess.SQL.Properties.Resources",
#if NET40
				typeof(OpheliaSuiteV2.Core.DataAccess.SQL.IRepository).Assembly);
#else
				typeof(OpheliaSuiteV2.Core.DataAccess.SQL.IRepository).GetTypeInfo().Assembly);
#endif
		}
